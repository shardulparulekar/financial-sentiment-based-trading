...
/* Hide ALL sidebar toggle controls — we use our own FAB */
[data-testid="stSidebarCollapsedControl"],
[data-testid="stSidebarUserContent"] + div,
button[data-testid="baseButton-headerNoPadding"],
[data-testid="collapsedControl"] { display: none !important; }
/* Sidebar overlays page — does NOT push content */
...
st.markdown("""
<style>
/* Hide the S button text and border completely, position over the FAB */
div[data-testid="stMainBlockContainer"] div[data-testid="stBaseButton-secondary"]:has(> button p:empty),
div[data-testid="stMainBlockContainer"] button[data-testid="baseButton-secondary"][title="Toggle SAGE"],
div[data-testid="stMainBlockContainer"] button[kind="secondary"][aria-label="Toggle SAGE"] {
    position: fixed !important;
    bottom: 4.5rem !important;
    right: 0.5rem !important;
    width: 90px !important;
...
/* Catch-all: hide any button whose only content is "S" near the FAB area */
#sage-fab-overlay {
    position: fixed !important;
    bottom: 4.5rem !important;
    right: 0.5rem !important;
...
/* Keep sidebar push subtle — only when open */
[data-testid="stSidebar"][aria-expanded="true"] ~ [data-testid="stMainBlockContainer"] {
    margin-right: 0 !important;
}
</style>
...
# Wrap button in a named div we can target reliably
st.markdown('<div id="sage-fab-overlay">', unsafe_allow_html=True)
if st.button("　", key="sage_toggle_btn", help="Toggle SAGE", use_container_width=True):
